            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <div class="col-md-1" style="margin-top: -22px;">
                    <a class="dropdown text-danger" data-bs-toggle="dropdown" aria-expanded="false">
                        <span id="notification_count" class="badge text-bg-warning rounded-pill position-relative dropdown-toggle" style="top: 15px; left: 12px;">{{getNotificationsCount()}}</span>
